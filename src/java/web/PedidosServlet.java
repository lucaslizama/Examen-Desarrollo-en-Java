...
public class PedidosServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Cliente cliente = (Cliente)request.getSession(false).getAttribute("usuario");
        cliente = clf.findByRut(cliente.getRut());
        
        request.setAttribute("listaPedido", cliente.getPedidoList());
